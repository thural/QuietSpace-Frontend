...
export default defineConfig(({ mode }) => {
  ...
  return {
    define: {
      ...
      'process.env.MOBILE_API_URL': JSON.stringify(process.env.MOBILE_API_URL || 'https://api-mobile.quietspace.com'),
      'process.env.VITE_ENABLE_WEBSOCKET': JSON.stringify(process.env.VITE_ENABLE_WEBSOCKET || 'true'),
      'process.env.VITE_ENABLE_PUSH_NOTIFICATIONS': JSON.stringify(process.env.VITE_ENABLE_PUSH_NOTIFICATIONS || 'true'),
      'process.env.VITE_ENABLE_BACKGROUND_SYNC': JSON.stringify(process.env.VITE_ENABLE_BACKGROUND_SYNC || 'true'),
      'process.env.VITE_CACHE_STRATEGY': JSON.stringify(process.env.VITE_CACHE_STRATEGY || 'persistent'),
      'process.env.VITE_ENABLE_OFFLINE_MODE': JSON.stringify(process.env.VITE_ENABLE_OFFLINE_MODE || 'true'),
    },
    resolve: {
