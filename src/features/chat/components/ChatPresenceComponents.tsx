...
/**
 * Demo component showing all presence features
 */
export const ChatPresenceDemo: React.FC = () => {
    ...
    return (
        <div className=\"max-w-4xl mx-auto p-6 space-y-6\">
            <h1 className=\"text-2xl font-bold text-gray-900\">Chat Presence Demo</h1>
            
            <div className=\"grid grid-cols-1 lg:grid-cols-2 gap-6\">
                {/* Chat Window */}
                <div className=\"border border-gray-200 rounded-lg overflow-hidden\">
                    <div className=\"px-4 py-3 border-b border-gray-200 bg-white\">
                        <h2 className=\"text-lg font-medium text-gray-900\">Chat Window</h2>
                    </div>
                    
                    {/* Messages area */}
                    <div className=\"h-64 p-4 bg-gray-50 overflow-y-auto\">
                        <div className=\"space-y-2\">
                            <div className=\"text-sm text-gray-600\">Chat messages would appear here...</div>
                        </div>
                    </div>
                ...
                <div>
                    ...
                    {/* Individual Presence Indicators */}
                    <div className=\"mt-6 border border-gray-200 rounded-lg p-4\">
                        <h3 className=\"text-lg font-medium text-gray-900 mb-4\">Individual Presence</h3>
