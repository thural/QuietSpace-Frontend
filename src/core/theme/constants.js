...
export const TYPOGRAPHY = Object.freeze({
    ...
    FONT_FAMILY: Object.freeze({
        SANS: Object.freeze(['Inter', 'system-ui', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'sans-serif']),
        SERIF: Object.freeze(['Georgia', 'Cambria', 'Times New Roman', 'Times', 'serif']),
        MONO: Object.freeze(['JetBrains Mono', 'Fira Code', 'Monaco', 'Cascadia Code', 'SF Mono', 'Consolas', 'monospace']),
        DISPLAY: Object.freeze(['Inter Display', 'Inter', 'system-ui', 'sans-serif']),
    }),
...
export const BREAKPOINTS = Object.freeze({
    ...
    CONTAINER_MAX_WIDTHS: Object.freeze({
        SM: '540px',
        MD: '720px',
        LG: '960px',
        XL: '1140px',
...
export const ANIMATION = Object.freeze({
    ...
    KEYFRAMES: Object.freeze({
        FADE_IN: Object.freeze({
            from: { opacity: 0 },
            to: { opacity: 1 },
        }),
        FADE_OUT: Object.freeze({
            from: { opacity: 1 },
            to: { opacity: 0 },
        }),
        SLIDE_UP: Object.freeze({
            from: { transform: 'translateY(100%)' },
            to: { transform: 'translateY(0)' },
        }),
        SLIDE_DOWN: Object.freeze({
            from: { transform: 'translateY(-100%)' },
            to: { transform: 'translateY(0)' },
        }),
        SLIDE_LEFT: Object.freeze({
            from: { transform: 'translateX(100%)' },
            to: { transform: 'translateX(0)' },
        }),
        SLIDE_RIGHT: Object.freeze({
            from: { transform: 'translateX(-100%)' },
            to: { transform: 'translateX(0)' },
        }),
        SCALE_IN: Object.freeze({
            from: { transform: 'scale(0.9)', opacity: 0 },
            to: { transform: 'scale(1)', opacity: 1 },
        }),
        SCALE_OUT: Object.freeze({
...
export const LAYOUT = Object.freeze({
    // Container padding
    CONTAINER_PADDING: Object.freeze({
        SM: '1rem',
        MD: '1.5rem',
        LG: '2rem',
        XL: '3rem',
    ...
    COMPONENT_HEIGHTS: Object.freeze({
        HEADER_SM: '3rem',
        HEADER_MD: '4rem',
        HEADER_LG: '5rem',
        SIDEBAR: '16rem',
...
export const CSS_VARIABLE_PREFIXES = Object.freeze({
    COLOR: '--color',
    SPACING: '--spacing',
