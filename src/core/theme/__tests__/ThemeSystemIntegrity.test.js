...
// Test core imports
import { themeSystem, ThemeSystem } from '../ThemeSystem.js';
import { themeContainer, THEME_TOKENS } from '../di/ThemeContainer.js';

// Test interface imports - removed type imports as they don't exist in JavaScript
...
describe('Theme System Integrity', () => {
    ...
    describe('Internal Module Isolation', () => {
        it('should have isolated token system', () => {
            // Test that we can import from internal modules
            expect(() => {
                require('../internal/tokens.js');
                require('../internal/types.js');
            }).not.toThrow();
        });
    ...
    describe('Self-Containment', () => {
        ...
        it('should have clean modular structure', () => {
            ...
            expect(() => {
                require('../ThemeSystem.js');
                require('../di/ThemeContainer.js');
                require('../interfaces/index.js');
                require('../providers/ThemeContext.js');
                require('../types/ProviderTypes.js');
                require('../internal/tokens.js');
                require('../internal/types.js');
            }).not.toThrow();
        });
    ...
    describe('Backward Compatibility', () => {
        it('should maintain existing API structure', () => {
            ...
            expect(() => {
                const system = require('../ThemeSystem.js');
