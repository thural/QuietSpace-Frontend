...
import { SAMLAuthProvider, SAMLProviders } from '../providers/SAMLProvider.js';
 ...
 * @property {string} [samlResponse] - SAML response
...
describe('SAMLAuthProvider', () => {
    ...
    describe('Logout Functionality', () => {
        test('should handle SAML logout with SLO URL', async () => {
            ...
            expect(result.metadata?.logoutUrl).toContain('okta.com');
        });
    ...
    describe('Security Features', () => {
        test('should generate unique request IDs', async () => {
            const credentials1 = { provider: SAMLProviders.OKTA };
            const credentials2 = { provider: SAMLProviders.OKTA };
