...
import { AuthProviderType, AuthEventType, AuthErrorType, AuthStatus } from './types/auth.domain.types.js';
...
export const AuthLogLevel = Object.freeze({
    DEBUG: 'debug',
    INFO: 'info',
    WARN: 'warn',
    ERROR: 'error',
...
/**
 * Validates if a value is a valid AuthLogLevel
 * @param {string} level - The level to validate
 * @returns {boolean} True if valid, false otherwise
 */
export function isValidAuthLogLevel(level) {
    return Object.values(AuthLogLevel).includes(level);
}
